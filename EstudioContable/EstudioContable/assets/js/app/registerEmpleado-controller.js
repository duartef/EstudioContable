App.controller('RegisterEmpleado', ['$scope', '$window', '$http', function ($scope, $window, $http) {
    $scope.$parent.header = { title: "Registro de Empleado", description: "Crea una cuenta." };
