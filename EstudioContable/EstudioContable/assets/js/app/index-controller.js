App.controller('IndexController', ['$scope', '$window', function ($scope, $window) {
    ...
    $scope.modules = [
        ...
        { rol: 1, name: "Vaciones", description: "Clic aqui para solicitar tus vacaciones!", colorClass: "bg-light-blue", appearTimeout: 0, iconClass: "fa-plane", link: "/Manage/Categorias" },
