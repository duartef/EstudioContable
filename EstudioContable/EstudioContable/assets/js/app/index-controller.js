App.controller('IndexController', ['$scope', '$window', function ($scope, $window) {
    ...
    $scope.modules = [
        ...
        { rol: 1, name: "Agregar Persona Jurídica", description: "Clic aqui para agregar Cliente.", colorClass: "bg-light-blue", appearTimeout: 0, iconClass: "fa-user-plus", link: "/Account/RegisterPersonaJuridica" },
        { rol: 1, name: "Agregar Persona Humana", description: "Clic aqui para agregar Cliente.", colorClass: "bg-light-blue", appearTimeout: 0, iconClass: "fa-user-plus", link: "/Account/RegisterPH" },
        { rol: 1, name: "Agregar Cliente", description: "Clic aqui para agregar Cliente.", colorClass: "bg-light-blue", appearTimeout: 0, iconClass: "fa-user-plus", link: "/Account/Register" },
